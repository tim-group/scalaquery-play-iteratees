/**
 * NOTE (2013-10-23, msiegel/ahepburn):
 *   Copied from ScalaQuery 0.10.0-M1:
 *   https://github.com/szeiger/scala-query/blob/0.10.0-M1/src/test/scala/org/scalaquery/test/util/TestDB.scala
 *
 * TODO (2013-11-14, msiegel): When we are ready, we should replicate what is done in the file
 *   this was copy-pasted from, to enable tests to run against multiple databases with provided
 *   configurations. First priority will be MySQL tested on Travis CI.
 */
